...
class ActualiteRepository extends ServiceEntityRepository
{
     ...
     * @return Actualite[]
     */
    public function findDernieresActialites( $nomTheme ) : array
    {
        return $this->createQueryBuilder('a')
            ->select('a', 'the')
            ->leftJoin('a.theme', 'the')
            ->Where('the.nom = :nomTheme or the.nom is null')
            ->setParameter('nomTheme', $nomTheme)
            ->orderBy('a.prioritaire', 'DESC')
